 ...
 *                     type: string
 */
kycRoute.post("/", middleware_1.authorize, (0, middleware_1.tryCatch)(kyc_controller_1.addKYC));
/**
 * @swagger
 * /kyc/process:
 *   post:
 ...
 *                     type: string
 */
kycRoute.post("/process", middleware_1.authorize, (0, middleware_1.tryCatch)(kyc_controller_1.processKYCRequest));
/**
 * @swagger
 * /kyc:
 *   get:
 ...
 *         description: Unauthorized
 */
kycRoute.get("/", middleware_1.authorize, (0, middleware_1.tryCatch)(kyc_controller_1.listKYCRequests));

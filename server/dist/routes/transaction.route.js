...
const transRoute = express_1.default.Router();
/**
 * @swagger
 ...
 */
transRoute.post("/flight/book", middleware_1.authorize, (0, middleware_1.tryCatch)(transaction_controller_1.bookFlight));
/**
 * @swagger
 ...
 */
transRoute.post("/crypto/sell-order", middleware_1.authorize, (0, middleware_1.tryCatch)(transaction_controller_1.createCryptoSellOrder));
/**
 * @swagger
 ...
 *                   example: "An error occurred, please contact admin"
 */
transRoute.put("/crypto/confirm-order", middleware_1.authorize, (0, middleware_1.tryCatch)(transaction_controller_1.confirmCryptoOrder));
/**
 * @swagger
 ...
 *                   example: "An error occurred, please contact admin"
 */
transRoute.get("/:transId", middleware_1.authorize, (0, middleware_1.tryCatch)(transaction_controller_1.getTransactionByTransId));
/**
 * @swagger
 ...
 *                   example: "An error occurred, please contact admin"
 */
transRoute.post("/giftcard/sell-order", middleware_1.authorize, (0, middleware_1.tryCatch)(transaction_controller_1.createGiftCardTransaction));

 ...
 */
AuthRoute.post("/login", (0, middleware_1.tryCatch)((req, res) => (0, auth_controller_1.login)(req, res)));
/**
 * @swagger
 * /auth/adminlogin:
 *   post:
 ...
 *                   description: list of errors
 */
AuthRoute.post("/adminlogin", (0, middleware_1.tryCatch)((req, res) => (0, auth_controller_1.adminLogin)(req, res)));
/**
 * @swagger
 * /auth/reset-password:
 *   post:
 ...
 *                   description: list of errors
 */
AuthRoute.post("/reset-password", (0, middleware_1.tryCatch)((req, res) => (0, auth_controller_1.resetPassword)(req, res)));
/**
 * @swagger
 ...
 *                   description: list of errors
 */
AuthRoute.post("/reset-password/confirm", (0, middleware_1.tryCatch)((req, res) => (0, auth_controller_1.confirmPasswordReset)(req, res)));
AuthRoute.post("/activate", (0, middleware_1.tryCatch)(auth_controller_1.activateAccount));
